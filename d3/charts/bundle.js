(function (global, factory) {
	...
	!function() {
	  ...
	  if (typeof undefined === "function" && undefined.amd) this.d3 = d3, undefined(d3); else if (module.exports) module.exports = d3; else this.d3 = d3;
	}();
	});
	...
	class Chart extends EventEmitter {
		constructor (opt) {
			...
			this.opt = opt;
			this.data = opt.data || [];
			this.data.max = undefined(this.data);
			this.data.min = undefined(this.data);
